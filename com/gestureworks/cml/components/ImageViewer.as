package com.gestureworks.cml.components 
{
	...
	/**
	 * The ImageViewer is a component that is primarily meant to display a image on the front side and meta-data on the back side
	...
	public class ImageViewer extends Component 
	{
		...
		override public function displayComplete():void
		{
			...
			// automatically try to find elements based on css class - this is the v2.0 implementation
			if (!image)
			...
			// automatically try to find elements based on id
			if (!image)
			...
			if (!front)
				front = searchChildren("#front");
			if (!back)
				back = searchChildren("#back");				
