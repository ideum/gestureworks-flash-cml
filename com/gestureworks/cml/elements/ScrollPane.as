package com.gestureworks.cml.elements
{
	...
	public class ScrollPane extends TouchContainer
	{
		...
		private var _thumbFill:String = "0x666666";
		...
		public function updateText(txt:String):void {
			var text:Text = content.getChildAt(0) as Text;
			text.htmlText = txt; 
			text.width = width-20;
			updateLayout();
		}
		...
		override public function clone():* {
			...
			v.push("childList", "vBar", "hBar", "_mask", "content","contentGestures");// , "_content");
			var clone:ScrollPane = CloneUtils.clone(this, this.parent, v);
			DisplayUtils.removeAllChildren(clone);	
			DisplayUtils.removeAllChildren(clone.content);			
						
			clone.init();			
			clone.addChild(Text(content.getChildAt(0)).clone());
			return clone;
		}
